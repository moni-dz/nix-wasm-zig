...
extern fn get_type(value: ValueId) Type;
extern fn make_int(value: i64) Value;
extern fn get_int(value: ValueId) i64;
extern fn make_float(value: f64) Value;
extern fn get_float(value: ValueId) f64;
extern fn make_string(ptr: [*]const u8, len: usize) Value;
extern fn copy_string(value: ValueId, ptr: [*]u8, max_len: usize) usize;
extern fn make_path(base: ValueId, ptr: [*]const u8, len: usize) Value;
extern fn copy_path(value: ValueId, ptr: [*]u8, max_len: usize) usize;
extern fn make_bool(b: i32) Value;
extern fn get_bool(value: ValueId) i32;
extern fn make_null() Value;
extern fn make_list(ptr: [*]const Value, len: usize) Value;
extern fn copy_list(value: ValueId, ptr: [*]Value, max_len: usize) usize;
extern fn make_attrset(ptr: [*]const Attr.Input, len: usize) Value;
extern fn copy_attrset(value: ValueId, ptr: [*]Attr.Output, max_len: usize) usize;
extern fn copy_attrname(value: ValueId, attr_idx: usize, ptr: [*]u8, len: usize) void;
extern fn get_attr(value: ValueId, ptr: [*]const u8, len: usize) ValueId;
extern fn call_function(fun: ValueId, ptr: [*]const Value, len: usize) Value;
extern fn make_app(fun: ValueId, ptr: [*]const Value, len: usize) Value;
extern fn read_file(value: ValueId, ptr: [*]u8, max_len: usize) usize;

pub fn nixPanic(msg: []const u8) noreturn {
    log_extern.panic(msg.ptr, msg.len);
}

pub fn nixWarn(msg: []const u8) void {
...
pub fn entrypoint(comptime moduleInit: ?fn () void) void {
    @export(&struct {
        fn nix_wasm_init_v1() callconv(.c) void {
            nixWarn("hello from nix-wasm-zig");
